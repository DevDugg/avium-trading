  ...
  testimonials: [
    //   Original testimonials:
    {
      ...
      content: `Just completed the Avium beta cohort mentorship by Pidgeon . Here are my thoughts:
          ...
          Before the mentorship, I was purely an emotional trader and copied what everyone else was doing
          
          e.g. looking at the WW newsletter and TG calls. I felt like I was always a couple steps behind and 
          
          waiting for someone to tell me what to do 🫥 . Also, I did not have any TA experience.
          
          <br /><br />
          
          After the mentorship, I feel very comfortable looking at a chart and analyzing it. Though I am no TA
          ...
          In addition, I'm grateful that the mentorship has made me realize spot/investing is a form of 
          
          trading. I originally wanted to solely trade on futures and thought that was the only way to
          
          Valhalla. This isn’t the case anymore and already incorporated gains from spot trading and looking
          
          forward to more.

          <br /><br />
          
          Lastly, the mentorship has helped me to filter out the news , larps, grifters, and twitter feed...and
          
          purely look at the charts. This has tremendously helped me keep my sanity when i see volatile
          ...
          For my fellow pupils Aber, Roigadaa, Etash, happy to have learned alongside you and hope you feel
          
          the same way above. Good luck with your journey!
    ...
    },
    {
      ...
      email: "Mentorship Pupil",
      content: `
      I would like to share my experience from the mentorship for the new pupils and whoever is interested or in doubt of embracing this journey.
